...
import cv2
import argparse
from utils.preprocess_helpers import transform_color

parser = argparse.ArgumentParser()

parser.add_argument("--date", default="220719_2", type=str, help="Date of the flight to be added.")
parser.add_argument("--flight_nr", default="flight_11", type=str, help="Flight number.")

parser.add_argument("--path_to_X_train", default="data/training/flight9_16_7_11/train_images.npy", type=str, help="Path to current training images in .npy file format.")
parser.add_argument("--path_to_y_train", default="data/training/flight9_16_7_11/train_masks.npy", type=str, help="Path to current training masks in .npy file format.")
...
def main():
    ...
    for i, idx in enumerate(indeces):
        ...
        mask[mask==20]=2
        image = cv2.imread('data/prediction/preprocessed/{0}/{1}.png'.format(params['date'], idx), 0)
